...
Source0:        https://files.pythonhosted.org/packages/a8/12/63bdb3ee8e0bd7dd0476e79f0f130c1caeff408a1b1e5531ae9891805f7d/python-mpd2-%{version}.tar.bz2
...
%prep
%autosetup -n python-mpd2-%{version}
# python 2.7 has no support for asyncio
rm -f mpd/asyncio.py 
...
%changelog
* Sun Jul 29 2018 Guenter Bartsch <guenter@zamia.org> - 1.0.0-1
- Initial package
