...
Source0:        https://files.pythonhosted.org/packages/3a/20/c81632328b1a4e1db65f45c0a1350a9c5341fd4bbb8ea66cdd98da56fe2e/numpy-%{version}.zip
...
%files
%doc THANKS.txt INSTALL.rst.txt site.cfg.example LICENSE.txt
